...
var MultiSiteCookie = {
    ...
    localWebsiteFunctions: {
        ...
        associateClientId: function (cookieName, shouldUpdate, cidOverride) {
            if (typeof MultiSiteCookie.data.getCookie(cookieName) === "undefined") {
                ...
                if (typeof cid !== "undefined") {
                    var setEventPath = '/api/xdb/Analytics/TriggerEvent/Event/?eventName=updateGoogleCidFromVrtp&data=' + cid + '&shouldUpdate=' + shouldUpdate;
                    $.ajax({
                        type: 'POST',
                        url: setEventPath,
                        dataType: 'json',
         ...
         *   The method checks to see if the contentWindow is ready to go and if it is passes control to vrtpInitialiseBroadcast().
         */
