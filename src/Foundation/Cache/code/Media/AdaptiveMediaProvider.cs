...
namespace Site.Foundation.Analytics.Media
{
    public class AdaptiveMediaProvider : MediaProvider
    {
        /// <summary>
        /// The resolution break-points to use (screen widths, in pixels)
        /// </summary>
        private static readonly int[] _resolutions = Sitecore.Configuration.Settings.GetSetting("resolutions").Split(',').Select(int.Parse).ToArray();
        ...
        /// </summary>
        private static readonly string _cookieName = Sitecore.Configuration.Settings.GetSetting("resolutionCookieName");
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsResolutionCookieSet()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetLargestBreakpoint()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetCookieResolution()
        {
            // Double check that the cookie identifying screen resolution is set
            if (!IsResolutionCookieSet())
                return 0;
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetCookiePixelDensity()
        {
            // Double check that the cookie identifying screen resolution is set
            if (!IsResolutionCookieSet())
                return 1;
